...
Функционально модуль ОЗУ 6.120.108 состоит из следующих узлов:
...
Функциональная схема модуля ОЗУ показана на рис. 8.

![fig-08](i/fig-08-small.png)

*Рис.8*

### 6.2.1 Адресный дешифратор
...
Одновибратор D22.1 формирует импульсы нижнего поля кадра, определяющие
расстояние от нижней кромки рабочего растра до конца полного рабочего поля
...
### 6.2.3 Регистры прямой и косвенной адресации
...
### 6.2.4 Адресный мультиплексор и накопитель
...
### 6.2.5 Видеорегистр данных и модулятор
...
### 6.2.6 Канальный регистр данных
...
косвенной адресации, начиная с адреса 140000 (адрес слова). Оставшиеся 32
Кбайта расширенной памяти отведены под электронный диск. Доступ к ним
осуществляется также с помощью косвенной адресации (адреса слов
100000...137777).

### 6.2.7 Перечень элементов модуля ОЗУ 6.120.108
...
| D30       | К555ЛА3          |                                   | 1      |
| D31...D34 | К555КП12         | мультиплексор адреса ОЗУ          | 4      |
...
| D57, D58  | КР588ВА1         | канальный выходной буфер          | 2      |
| D59       | КМ555ЛН1         |                                   | 1      |
| D60       | К555ЛА3          |                                   | 1      |
| D61...D63 |                  | R×9                               | 3      |
