...
независимых каналов, организованных на основе 2 шестнадцатиразрядных
счетчиков.
...
фиксированные коэффициенты деления соответственно 2, 4, 8, 16, 32, 64, 128.
...
#### Перечень элементов таймера 3.056.006 ПЭЗ
